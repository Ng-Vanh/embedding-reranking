...
INPUT_DIR = "/mnt/disk2/anhnv/rr/stage1"
OUTPUT_FILE = os.path.join(INPUT_DIR, "res_all_test_results_final_model.json")

# Pattern các file kết quả
PATTERN = os.path.join(INPUT_DIR, "test_results_final_model_*.json")
