...
# Import ORIGINAL Focal-InfoNCE loss
...
# Output directory
OUTPUT_DIR = "./stage1_original_focal_infonce_bge-small"
...
if USE_SIMPLIFIED_LOSS:
    ...
    loss_name = "SimplifiedOriginalFocalInfoNCELoss"
else:
    train_loss = OriginalFocalInfoNCELoss(
        model=model,
        temperature=TEMPERATURE,
        margin=MARGIN,
    )
    loss_name = "OriginalFocalInfoNCELoss"
